...
!      implicit none
      ...
      dimension omgrtp(nnmax)  ! added by me 
...
!  common containing angular_velocity, added by me 
...
c   
      ...
      save
c
      write(*,*) 'Subroutine rotker called' 

!   Input angular velocity value from mesa
      write(*,*) 'Input omega as omgrtp(n)'
      do n=1,nnmax
         omgrtp(n) = omega0  ! uniform rotation, from star centre to surface
      end do 

      irotkr = ipara_irotkr 
      write(*,*) 'Show me irotkr in rotker' 
      write(*,*) irotkr 

      write(*,*) 'Show me few values of omgrtp(n)'
      do n=1,3
	write(*,*) omgrtp(n)
      end do 
c
...
c
      ...
      write(*,*) 'Begin rotation calculation'
...
c
	...
	write(*,*) 'rotational split(1) =', split(1)
...
c  Kara Burke second-order formulation
      write(*,*) 'Begin second-order rotation calculation' 
c
...
c..      end do
      ...
      write(*,*) 'rotational split(2) =', split(2) 
      write(*,*) 'rotational split(3) =', split(3)
...
!	 write(77,*) 'degree, order, frequency, (1-beta), del1',
!     *        'del2, del3'
         write(77,1042) el,cs(19),freq,1.-beta,del1(nn),
     *        del2(nn),del3(nn)

         open(78,file="2ndorderas")
!	 write(78,*) 'degree, order, frequency, (1-1), del1as',
!     *        'del2as, del3as' 
