...
!      integer :: el
c
!      common/rotdat/ iem, irotsl, nsem, idems   ! added by me, uncomment if passing as subroutine arg
!      integer :: iem, irotsl, nsem, idems
      integer, intent(in) :: iem, irotsl   ! comment this if passing with commons
c
...
c
      write(*,*) 'Subroutine sigscn called'

      write(*,*) 'Show me irotsl, iem, ispcpr, nn in sigscn'
      write(*,*) irotsl, iem, ispcpr, nn
...
c
	  write(*,*) 'Show me iem, irotsl, ispcpr, and sig before-' 
          write(*,*) 'calling sigout in sigscn'
	  write(*,*) iem, irotsl, ispcpr, sig

	  write(*,*) 'calling sigout from sigscn'
